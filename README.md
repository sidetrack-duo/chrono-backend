...
chrono.(크로노)는 GitHub 개발 활동을 중심으로, 사이드 프로젝트의 진행 상황을 자연스럽게 기록하고 확인할 수 있도록 만든 서비스입니다. 프로젝트를 진행하다 보면 진행 상황을 따로 정리하지 못한 채 흐름이 끊기는 경우가 종종 있습니다. 문서화하여 관리하려 해도 꾸준히 기록하는 일 자체가 부담으로 느껴질 때도 많습니다.
